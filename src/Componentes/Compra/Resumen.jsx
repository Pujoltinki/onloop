...
const Resumen = ({ 
    ...
    return (
        <Box sx={{ padding: { xs: 1, sm: 2 }, maxWidth: '800px', margin: 'auto' }}>
            ...
            <Typography variant="h6"><b>Precio de compra: ${precioTotal()}</b></Typography>
            <Typography variant="h6"><b>Precio de envío: ${comunaPrecio}</b></Typography>
            <Typography variant="h6"><b>Total a pagar: ${precioTotal() + comunaPrecio}</b></Typography>
        </Box>
    );
};
